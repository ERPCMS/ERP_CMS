...
{
    public partial class MainFile : System.Web.UI.Page
    {
        ...
        protected void btnNextBL_Click(object sender, EventArgs e)
        {
            //ScriptManager.RegisterStartupScript(Page, typeof(Page), Guid.NewGuid().ToString(), "$('#tabs').tabs('select', 2);", true);
        }
    }
}
