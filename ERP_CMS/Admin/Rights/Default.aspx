<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ERP_CMS.Admin.Rights.Default" %>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            Select User:</label>
                        <div class="col-sm-9">
                            <asp:DropDownList runat="server" ID="ddlUser" OnSelectedIndexChanged="ddlUser_SelectedIndexChanged" CssClass="form-control" AutoPostBack="True">
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel" id="pnlDetails" runat="server" visible="False">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-sm-6">
                            ...
                            <asp:GridView ID="grdNonAssignedRights" runat="server" AutoGenerateColumns="False"
                                ...
                                Width="100%"
                                OnRowDataBound="grdNonAssignedRights_RowDataBound">
                        ...
                        <div class="col-sm-6">
                            ...
                            <asp:GridView ID="grdAssignedRights" runat="server" AutoGenerateColumns="False" CellPadding="5"
                                CssClass="table table-hover table-striped table-bordered" DataKeyNames="UserLinkID"
                                Width="100%"
                                OnRowDataBound="grdAssignedRights_RowDataBound"
                                OnRowDeleting="grdAssignedRights_RowDeleting">
                                <AlternatingRowStyle CssClass="grdAltRow" />
                                <Columns>
                                            ...
                                            <asp:GridView ID="grdAssignedRightsInner" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Existing Inner Rights">
                                                        <ItemTemplate>
                                                            <asp:HiddenField ID="hdnPageRightID" runat="server" Value='<%# Eval("PageRightID") %>' />
                                                            <asp:HiddenField ID="hdnEmpRightID" runat="server" Value='<%# Eval("UserRightID") %>' />
                                                            <asp:Label ID="lblMenuLinkTextInner" runat="server" Text='<%# Eval("Title") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                    ...
                    <div class="form-group text-right">
                        ...
                        <asp:Button ID="btnSave" runat="server" Text="Update Rights" ValidationGroup="Save"
                           OnClick="btnSave_Click" CssClass="btn btn-primary" ClientIDMode="Static" />
                    </div>
                </div>
            </div>
        </ContentTemplate>
