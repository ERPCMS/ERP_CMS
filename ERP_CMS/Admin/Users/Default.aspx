<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ERP_CMS.Admin.Users.ManageUsers" %>
           ...
           <%-- <div class="form-group">
            ...
            <div class="form-group text-right">
                   ...
                   <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlDept"
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password does not match with confirm password..." ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" ValidationGroup="Save"></asp:CompareValidator>

                    <asp:Button ID="btnSave" runat="server" Text="Create User"  ValidationGroup="Save"
